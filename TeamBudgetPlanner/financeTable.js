var crudFin = new function() {
    ...
    this.createTable = function () {
        ...
        for (var i = 0; i < this.projects.length; i++) {
            ...
            lblCancel.innerHTML = '✖';
            lblCancel.setAttribute('onclick', 'crudFin.Cancel(this)');
            ...
            btSave.setAttribute('onclick', 'crudFin.Save(this)');       // ADD THE BUTTON's 'onclick' EVENT.
            ...
            btUpdate.setAttribute('onclick', 'crudFin.Update(this)');   // ADD THE BUTTON's 'onclick' EVENT.
            ...
            btDelete.setAttribute('onclick', 'crudFin.Delete(this)');   // ADD THE BUTTON's 'onclick' EVENT.
